...
module.exports = {
    ...
    async execute(client, message, args) {
        if(!message.channel.nsfw) return message.channel.send("Due to this command using Urban Dictionary, This can only be used in an NSFW channel for the time being.")
