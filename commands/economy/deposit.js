        ...
        if (!profileData) {
            ...
            if (args[0] == "all") {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setDescription(`successfully deposited **${profileData.coin} coins** to your bank account`)
                    .setColor("RANDOM")
                    .setTimestamp()
                ...
                try {
                    ...
                    const embed = new Discord.MessageEmbed()
                        .setTitle(`**${message.author.username}'s** Bank`)
                        .setDescription(`Successfully deposited ${amount} coins to your bank account`)
                        .setColor("RANDOM")
                        .setTimestamp()
                    message.channel.send(embed)
                } catch (err) {
