    ...
    async execute(client, message, args) {
        ...
        if (!profileData) {
            ...
            if (talkedRecently.has(message.author.id)) {
                ...
                if (person.coin < amount) return message.channel.send("this person can't be stolen from as they have less than **1250 coins**")
                ...
                const begdescription = [`You've successfully stolen **${convstring} coins** from That user`]
