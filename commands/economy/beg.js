    ...
    async execute(client, message, args) {
        ...
        if (!profileData) {
            ...
            if (talkedRecently.has(message.author.id)) {
                ...
                const begdescription = [`You little poor beggar. here take **$${convstring} coins**`, `Here take **$${convstring} coins** and invest it.`, `Aw man i only got $30 in my wallet.. I can give you **$${convstring} coins**`]
