...
module.exports = {
    ...
    description: "blackjack is a game about getting close to 21 without going over. Ace's are 1 or 11. go over 21 and your busted",
    ...
    async execute(client, message, args) {
        ...
        // Spam Users
        await message.reply('Game of BlackJack Started. Type `join` to join in, game starting soon');
        ...
        if (joinMessages.size === 0) throw new Error('Nobody joined the game'), message.channel.send('nobody else joined in time.');
