...
class YouTube {
    ...
    static async search(query, options) {
        ...
        if (!YouTube.get("api")) {
            ...
            const html = await Util_1.default.getHTML(url, requestOptions);
     ...
     */
    static async getVideo(url, requestOptions) {
        if (!url)
        ...
        if (!YouTube.get("api")) {
            const html = await Util_1.default.getHTML(`${url}&hl=en`, requestOptions);
